...
void main(List<String> args) {
  ...
  if (!file.existsSync()) {
    print('\x1B[31m[coverage] ✖\x1B[0m lcov.info not found at $lcovPath');
    exit(1);
  }
  ...
  if (totalLines == 0) {
    print('\x1B[31m[coverage] ✖\x1B[0m No coverage data found.');
    exit(1);
  }
...
''';
  ...
  print(
    '\x1B[32m[coverage] ✔\x1B[0m Coverage badge generated → $svgPath ($percent%)',
  );
}
